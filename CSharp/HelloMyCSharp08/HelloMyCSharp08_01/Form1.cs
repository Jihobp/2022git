...
namespace HelloMyCSharp08_01
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //var 대신 다른거 적어도 됨. 타입을 알면, 타입을 적어줘도 됨.
            foreach(Product p in products)
            {
                MessageBox.Show($"{p.name}"); //이름만 출력해보장
            }
        }
        ...
        void test(ref int a) //ref는 위치를 가져온다.
        {   //ref는 .....
        ...
        void test2(out int a) //out이 붙으면 반드시 값을 바꿔줘야한다. 
        {
            a = 100;//반드시 대입 연산자 필요, 
            Console.WriteLine(a); 
        }
