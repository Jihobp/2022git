...
namespace HelloMyCSharp10_01
{
    ...
    public partial class Form1 : Form
    {
        ...
        //executeFunc  오버로딩
        //public void executeFUunc(VoidFunc v, int c)
        //이번엔 매개변수와 반환형이 필요한 함수를 i 라는 변수에 
        //받아온 다음에 매개변수는 num으로 하고, i 의 반환형을 활용
        ...
        public void executeFunc(VoidFunc v, int c) //함수의 매개변수로 함수가 들어온것. 함수를 c번만큼 실행한다. 
        {
            for (int i = 0; i < c; i++)
                v();
        }
        ...
        public Form1()
        {
            ...
            //button4 같은 경우엔 첫번째 매개변수 object, 
            //두번째 매개변수 EventArgs 인 함수라면
            //누구나 다 이벤트 추가됨
            //함수를 아래와 같이 축약할 수 있다.
            button4.Click += (s, e) =>
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            //람다 
            //무명 델리게이트를 더 줄인 형태
            //무명 델리게이트와 마찬가지로 간단하게 함수를 쓰고 싶을 때 쓴다.
            //한 번 밖에 안 쓰이거나 임시로 쓰는 함수 쓸 때 이렇게 함. 
            //메모리 관리 측면에서도 이게 더 효율적.
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            //세제곱하는 함수를 매개변수로 함.
            //매개변수는 5이다. 
            //이 함수가 executeFunc 안으로 들어가는겁니다 'ㅅ' /
