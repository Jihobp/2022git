...
namespace HelloMyCSharp10_03
{
    public partial class Form1 : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            //2. 익명객체로 된 list를 만든다. a,b,c 대신에 age, money를 넣기.
            //money = (age *100)

            //list 에 있는 
            var output = from item in list //item 에 배열의 값 넣어쥼. 
                             //where 전부 출력할거라 where 필요 x
                             //ctrl k+f 배열정렬. 
                         select new
                         {
                             age = item,
            ...
            {
                label3.Text += item + "";
                label4.Text += $"나이{item.age}, 돈{item.money}이 있습니당.\n";
            }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            //Q. 만약에 1000원 넘는 거만 나오게 하고, 비싼 순으로 정렬하고
            //싶다면 어떻게 해야할까요?
