...
class Teacher{
	...
	public Teacher(String n, String g) {	// 매개변수 2개
		this.name=n;
		this.year=0;
		this.gender=g;
	}
...
public class java0822 {
	public static void main(String args[]) {
		...
		// 여기까진 "객체 생성은 안 됬지만", 객체를 생성할 배열 공간이 주어짐
		// 객체 배열에 대한 객체 생성
		...
		j[0]=new Jiho()
		System.out.println("자신의 이름과 성별은?");
		System.out.println("이름: "+j[i].getName());
		System.out.println("성별: "+j[i].getName());
		}*/
	}
}
