...
int main()
{
	...
	char sign = calcul(); // calcul이랑 함수롤 호출하면 숫자 두개 호출하고 
	printf("기호는 %c입니다.\n", sign); //그거에 대한 결과를 프린트.
	...
	//입력하는거 scnaf가 싫다? >>> calcul_sign(30,30); 30-30해서 0을 출력하는 것.
