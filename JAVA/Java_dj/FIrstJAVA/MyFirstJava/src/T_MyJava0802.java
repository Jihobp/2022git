...
public class T_MyJava0802 {
	public static void main(String args[]) {
		...
		int num=s.nextInt(); 		//학생수
		int score[]=new int [num];	//new int  기억할게!!!!!!!!!!!!!!!!!!!!! 정수를 입력받기 위한 공식.
		int sum=0;					//총합을 지정하는 변수
		for(int i=0;i<num;i++) {		//반복문은 몇번 입력을 받기 위해 쓰는 것!!!!!!!!!!!ㅇㅅㅇ
			score[i]=s.nextInt();	
			sum+=score[i];
		}
