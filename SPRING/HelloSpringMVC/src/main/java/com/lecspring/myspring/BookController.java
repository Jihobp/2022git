...
public class BookController {
	...
	//create - > detail - >update 호출 - > update.jps창으로 보내줌당.
	...
	//페이징  처리 위해서 매개변수가 2개가됨.@Requestparam 도 두개
	//기존의 객체 매개변수인 map과 더불어서
	//현재페이지를 의미하는 nowPage도 같이 보내옴
	...
	(@RequestParam Map<String,Object> map,
		...
		int totalCount = //ceil : 무조건 올리는거 // flow:내림 //round:반올림
				(int)Math.ceil						
				(this.bookService.countBookBoard(map)/CNT); //countBookBoard을 cnt로 나누고 
